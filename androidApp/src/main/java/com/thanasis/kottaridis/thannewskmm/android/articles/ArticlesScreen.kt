package com.thanasis.kottaridis.thannewskmm.android.articles
...
fun ArticlesScreen(
    ...
    val articlesState = articlesViewModel.state.collectAsState()
    ...
    Column {
        ...
        if (articlesState.value.articles.isNotEmpty()) {
            ArticlesListView(articlesViewModel.state.value.articles)
        }
    }
}
...
// TODO: - Create generic implementation via navigator
@Composable
fun Loader() {
    Box(
